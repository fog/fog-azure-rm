  ...
  def test_create_storage_account_success
    ...
    @mock_promise.stub :value!, storage_acc_obj do
      @storage_accounts.stub :create, @mock_promise do
        assert_equal @azure_credentials.create_storage_account(@storage_account_arguments), Azure::ARM::Storage::Models::StorageAccount.serialize_object(storage_acc_obj.body)
      end
    end
  end
