    ...
    class AzureRM
      ...
      class Real
        def create_or_update_sql_server(server_hash)
          ...
          request_parameters = foramt_server_parameters(server_hash[:location], server_hash[:version], server_hash[:administrator_login], server_hash[:administrator_login_password])
          begin
        ...
        def foramt_server_parameters(location, version, admin_login, admin_password)
          parameters = {}
          properties = {}
