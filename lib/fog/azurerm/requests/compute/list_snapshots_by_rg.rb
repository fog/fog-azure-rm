module Fog
  module Compute
    class AzureRM
      ...
      class Real
        def list_snapshots_by_rg(resource_group_name)
          msg = "Listing all Snapshots in resource group: #{resource_group_name}"
          Fog::Logger.debug msg
          begin
            snapshots = @compute_mgmt_client.snapshots.list_by_resource_group(resource_group_name)
