    ...
    class AzureRM
      ...
      class Real
        def add_address_prefixes_in_virtual_network(resource_group_name, virtual_network_name, new_address_prefixes)
          ...
          virtual_network = define_virtual_network_object_for_add_address_prefixes!(resource_group_name, virtual_network_name, new_address_prefixes)
          begin
        ...
        def define_virtual_network_object_for_add_address_prefixes!(resource_group_name, virtual_network_name, new_address_prefixes)
          begin
          ...
          raise "Cannot add Address Prefix(s): Provided Address Prefix(s) is/are already added in Virtual Network: #{virtual_network_name}" if attached_address_prefixes & new_address_prefixes == new_address_prefixes
