...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'azure_mgmt_compute', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_resources', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_storage', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_network', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_dns', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_traffic_manager', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_sql', '~> 0.15.preview'
  spec.add_dependency 'azure_mgmt_key_vault', '~> 0.15.preview'
  spec.add_dependency 'azure-storage', '~> 0.15.preview'
