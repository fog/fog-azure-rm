module Fog
  module Network
    class AzureRM
      ...
      class Real
        def attach_route_table_with_subnet(resource_group, subnet_name, virtual_network_name, address_prefix, network_security_group_id, route_table_id)
          Fog::Logger.debug "Attaching Route Table with Subnet: #{subnet_name}."

          subnet = define_subnet_object_for_attach_route_table(address_prefix, network_security_group_id, route_table_id)
          begin
        ...
        def define_subnet_object_for_attach_route_table(address_prefix, network_security_group_id, route_table_id)
      ...
      class Mock
        def attach_route_table_with_subnet(*)
          {
