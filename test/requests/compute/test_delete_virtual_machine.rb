...
class TestDeleteVirtualMachine < Minitest::Test
  ...
  def test_delete_virtual_machine_success
    ...
    @promise.stub :value!, response do
      @virtual_machines.stub :delete, @promise do
        assert_equal @service.delete_virtual_machine('fog-test-rg', 'fog-test-server'), response
      end
    end
  end
  ...
  def test_delete_virtual_machine_failure
    ...
    @promise.stub :value!, response do
      @virtual_machines.stub :delete, @promise do
        assert_raises(ArgumentError) { @service.delete_virtual_machine('fog-test-rg', 'fog-test-server') }
      end
    end
  end
end
