    ...
    class AzureRM
      ...
      class Real
        def add_dns_servers_in_virtual_network(resource_group_name, virtual_network_name, new_dns_servers)
          ...
          virtual_network = define_virtual_network_object_for_add_dns!(resource_group_name, virtual_network_name, new_dns_servers)
          begin
        ...
        def define_virtual_network_object_for_add_dns!(resource_group_name, virtual_network_name, new_dns_servers)
          begin
