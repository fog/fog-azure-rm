    ...
    class AzureRM
      ...
      class ExpressRouteCircuitPeering < Fog::Model
        ...
        def save
          ...
          circuit_peering = service.create_or_update_express_route_circuit_peering(resource_group, name, circuit_name, peering_type, peer_asn, primary_peer_address_prefix, secondary_peer_address_prefix, vlan_id, advertised_public_prefixes, advertised_public_prefix_state, customer_asn, routing_registry_name)
