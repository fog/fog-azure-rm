  ...
  def test_create_network_interface_success
    ...
    @promise.stub :value!, mocked_response do
      @network_interfaces.stub :create_or_update, @promise do
        assert_equal @service.create_network_interface('fog-test-rg', 'fog-test-network-interface', 'West US', 'fog-test-subnet-id', 'fog-test-ip-configuration', 'Dynamic'), expected_response
      end
    end
  end
    ...
    @promise.stub :value!, response do
      @network_interfaces.stub :create_or_update, @promise do
        assert_raises ArgumentError do
          @service.create_network_interface('fog-test-rg', 'fog-test-network-interface', 'West US', 'fog-test-subnet-id', 'fog-test-ip-configuration')
        end
      end
    end
  end
    ...
    @promise.stub :value!, response do
      @network_interfaces.stub :create_or_update, @promise do
        assert_raises RuntimeError do
          @service.create_network_interface('fog-test-rg', 'fog-test-network-interface', 'West US', 'fog-test-subnet-id', 'fog-test-ip-configuration', 'Dynamic')
        end
      end
    end
  end
