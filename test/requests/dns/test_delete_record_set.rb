  ...
  def test_delete_record_set_success
    @token_provider.stub :get_authentication_header, 'Bearer <some-token>' do
      RestClient.stub :delete, true do
        assert @service.delete_record_set('fog-test-record-set', 'fog-test-rg', 'fog-test-zone', 'A')
      end
    end
  end
  ...
  def test_delte_record_set_failure
    @token_provider.stub :get_authentication_header, 'Bearer <some-token>' do
      assert_raises ArgumentError do
        @service.delete_record_set('fog-test-record-set', 'fog-test-rg', 'fog-test-zone')
      end
    end
  end
